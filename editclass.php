...
if(isset($_POST['save_course'])) {
    ...
    $edit = mysqli_query($conn, "UPDATE classroom SET class_name='$class_name', details='$class_details' WHERE class_id='$class_id'");
    header("location:class.php");
}
$dis=mysqli_query($conn,"SELECT * FROM classroom WHERE class_id='$class_id ' ");
...
<head>
    ...
    <title>E-TIMETABLE/CLAROOM</title>
            ...
            <table>
                ...
                while ($row=mysqli_fetch_assoc($all)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo "<a href='editclass.php?class_id=$row[class_id]'>Edit</a>"; ?>
                        </td>
                        <td>
                            <?php echo "<a href='deleteclass.php?class_id=$row[class_id]'>Delete</a>"; ?>
                        </td>
                    </tr>
                <?php  
                }
